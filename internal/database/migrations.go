...
func RunMigrations(db *sql.DB) error {
	...
	statements := []string{
		...
		`alter table events drop constraint if exists events_template_id_foreign`,
		`alter table events alter column template_id drop default`,
		`alter table events alter column template_id type text using coalesce(template_id::text, '')`,
		`update events set template_id = '' where template_id is null`,
		`alter table events alter column template_id set default ''`,
		`alter table events alter column template_id set not null`,
